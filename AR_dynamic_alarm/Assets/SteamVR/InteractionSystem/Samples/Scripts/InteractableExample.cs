...
namespace Valve.VR.InteractionSystem
{
	...
	public class InteractableExample : MonoBehaviour
	{
		...
		private void OnHandHoverBegin( Hand hand )
		{
            ...
            // 내가 수정한 부분
            GameObject.Find("TrackedCamera").GetComponent<LoadResource>().CreateResource();
            // sphere에 컨트롤러 갖다댈 때 마다 interactable 하나 더 생성
            // TrackedCamera 컴포넌트의 LoadResource 스크립트의 CreateResource 함수 실행
        }
