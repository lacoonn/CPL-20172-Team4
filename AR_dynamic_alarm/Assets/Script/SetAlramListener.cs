...
public class SetAlramListener : MonoBehaviour
    ...
    , IColliderEventPressExitHandler
{
    ...
    private void Update()
    {
        visible = menuOnClick.getMenuVisible();
        if (Alram_number != 0 && visible == false)
        {
